...
export default function CGV() {
  usePageMeta('Conditions générales');
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            ...
            <p>
              ...
              Réseaux-Résident et toute personne physique effectuant un achat de carte de fidélité locale via 
              le site internet reseaux-resident.fr ou par tout autre canal de distribution.
            </p>

            <h2 className="font-serif text-2xl font-bold text-texte mt-8 mb-4">Article 2 - Description du service</h2>
            <p>
              La Réseaux-Résident est une carte de fidélité locale permettant à son détenteur de bénéficier 
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              ...
              <li>Réseaux-Résident Secondaire (2 cartes) : 20€/an</li>
            </ul>
            ...
            <p>
              La Réseaux-Résident est valable 12 mois à compter de la date d'achat. Elle peut être 
            ...
            <p>
              Réseaux-Résident ne peut être tenue responsable en cas de modification, suspension ou 
            ...
            <ul className="list-none mt-4 space-y-2">
              ...
              <li>✉️ Email : contact@reseaux-resident.fr</li>
            </ul>
          </div>
        </div>
      </div>
