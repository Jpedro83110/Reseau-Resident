        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            ...
            <p>
              ...
              Réseaux-Résident, dont le siège est situé à Sanary-sur-Mer (83110), France.
            </p>

            <h2 className="font-serif text-2xl font-bold text-texte mt-8 mb-4">2. Données collectées</h2>
            <p>
              Dans le cadre de l'inscription à la Réseaux-Résident, nous collectons les données suivantes :
            </p>
            ...
            <p className="mt-4">
              Pour exercer ces droits, contactez-nous à : <strong>privacy@reseaux-resident.fr</strong>
            </p>
            ...
            <ul className="list-none mt-4 space-y-2">
              ...
              <li>✉️ Email : privacy@reseaux-resident.fr</li>
            </ul>
          </div>
        </div>
      </div>
