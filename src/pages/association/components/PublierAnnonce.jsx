// src/pages/association/components/PublierAnnonce.jsx
// Formulaire pour qu'une association/club publie une annonce avec image.
import { useState } from 'react';
import { Newspaper, Image as ImageIcon, X } from 'lucide-react';
import { supabase } from '../../../lib/supabase';

const CATEGORIES = [
  'Annonce', 'Recrutement', 'Événement', 'Résultats', 'Information', 'Autre',
];

export default function PublierAnnonce({ associationId, villeId, auteurType = 'association', onPublie }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (imageFile) {
        ...
        const path = `actualites/${associationId}/${Date.now()}.${ext}`;
