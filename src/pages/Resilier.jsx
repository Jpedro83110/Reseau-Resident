      ...
      <div className="min-h-screen pt-32 pb-24 bg-creme flex items-center justify-center">
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}
          ...
          <p className="text-gray-600 mb-4">
            Votre carte Réseaux-Résident <strong>{numero}</strong> a été désactivée. Elle ne sera plus acceptée chez les commerçants partenaires.
          </p>
